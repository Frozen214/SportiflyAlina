...
namespace Sportifly.User
{
    public partial class TrainingSessions : Form
    {
        ...
        {
            var query = $"SELECT Клиент, Название, [Название статуса], [Дата тренировки] FROM vw_HistoryTraning WHERE [ID Клиента] = {PersonalData.UserId}";
    ...
    WHERE 
        ...
        AND [ID Клиента] = {PersonalData.UserId}";
